/* Flappy Bird!
* Now I'm just using the crappy nano as a slave receiver for the robomote to make sure it works    
...
void setup() {
  ...
  radio.begin();
  radio.openWritingPipe(addresses[1]); //I inverted these so they read from robomote. they must be opposite what is on the other microcontroller
  radio.openReadingPipe(1, addresses[0]); //I inverted these so they read from robomote. they must be opposite what is on the other microcontroller
